				...
				while(true) {
					try {
						...
						if(player1Name.equals(playerNames[playerIterator]))
						{
							...
							{
							    if (player1Play.equals("bang")) {
									String[] arrOfStr = player1Play.split(" ", 2);
									BANG.getPlayer("1").playCard(arrOfStr[0], BANG.getPlayer(arrOfStr[1]));
							    	// add buttons to allow the person to choose who to bang
									int value = Integer.parseInt(arrOfStr[1]);
									value -= 1;
                                    playerTransmit[value].writeUTF("You are being BANG'd");
                                } else {
                                    BANG.getPlayer("1").playCard(player1Play, null);
                                }
							}
							else{
								BANG.getPlayer("1").playCard(player1Play, null);
								if (!BANG.getPlayer("1").react()) {
									...
									BANG.getPlayer("1").takedamage();
									playerTransmit[0].writeUTF("Player 1 took damage");
									playerTransmit[1].writeUTF("Player 1 took damage");
									playerTransmit[2].writeUTF("Player 1 took damage");
									playerTransmit[3].writeUTF("Player 1 took damage");
									BANG.eliminatePlayers();
						...
						if(player2Name.equals(playerNames[playerIterator]))
						{
							...
							{
								if (player2Play.equals("bang")) {
									String[] arrOfStr = player2Play.split(" ", 2);
									BANG.getPlayer("2").playCard(arrOfStr[0], BANG.getPlayer(arrOfStr[1]));
									// add buttons to allow the person to choose who to bang
									int value = Integer.parseInt(arrOfStr[1]);
									value -= 1;
									playerTransmit[value].writeUTF("You are being BANG'd");
								} else {
									BANG.getPlayer("2").playCard(player2Play, null);
								}
							}
							else{
								BANG.getPlayer("2").playCard(player2Play, null);
								if (!BANG.getPlayer("2").react()) {
									...
									BANG.getPlayer("2").takedamage();
									playerTransmit[0].writeUTF("Player 2 took damage");
									playerTransmit[1].writeUTF("Player 2 took damage");
									playerTransmit[2].writeUTF("Player 2 took damage");
									playerTransmit[3].writeUTF("Player 2 took damage");
									BANG.eliminatePlayers();
						...
						if(player3Name.equals(playerNames[playerIterator]))
						{
							...
							{
								if (player3Play.equals("bang")) {
									String[] arrOfStr = player3Play.split(" ", 2);
									BANG.getPlayer("3").playCard(arrOfStr[0], BANG.getPlayer(arrOfStr[1]));
									// add buttons to allow the person to choose who to bang
									int value = Integer.parseInt(arrOfStr[1]);
									value -= 1;
									playerTransmit[value].writeUTF("You are being BANG'd");
								} else {
									BANG.getPlayer("3").playCard(player3Play, null);
								}
							}
							else{
								BANG.getPlayer("3").playCard(player3Play, null);
								if (!BANG.getPlayer("3").react()) {
									...
									BANG.getPlayer("3").takedamage();
									playerTransmit[0].writeUTF("Player 3 took damage");
									playerTransmit[1].writeUTF("Player 3 took damage");
									playerTransmit[2].writeUTF("Player 3 took damage");
									playerTransmit[3].writeUTF("Player 3 took damage");
									BANG.eliminatePlayers();
								}
							}
						}
						...
						{
							player4Play = Message;
							if(!BANG.getPlayer("4").react())
							{
								if (player4Play.equals("bang")) {
									String[] arrOfStr = player1Play.split(" ", 2);
									BANG.getPlayer("4").playCard(arrOfStr[0], BANG.getPlayer(arrOfStr[1]));
									// add buttons to allow the person to choose who to bang
									int value = Integer.parseInt(arrOfStr[1]);
									value -= 1;
									playerTransmit[value].writeUTF("You are being BANG'd");
								} else {
									BANG.getPlayer("4").playCard(player1Play, null);
								}
							}
							else{
								BANG.getPlayer("4").playCard(player1Play, null);
								if (!BANG.getPlayer("4").react()) {
									...
									BANG.getPlayer("4").takedamage();
									playerTransmit[0].writeUTF("Player 4 took damage");
									playerTransmit[1].writeUTF("Player 4 took damage");
									playerTransmit[2].writeUTF("Player 4 took damage");
									playerTransmit[3].writeUTF("Player 4 took damage");
									BANG.eliminatePlayers();
								}
							}
						}
